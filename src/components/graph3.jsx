...
function Graph3(){
    return (
        <div className="container-fluid" style={{backgroundColor: '86A7FC'}}>
            ...
            <div class="row g-0">
                <div class="col-sm" style={{margin: 2}}>
                    <KSB61EngineSpeed url={'http://10.23.107.201:3030/real/speed-data?table=tb_ksb61'}/>
                </div>
                <div class="col-sm" style={{margin: 2}}>
                    <KSB61EngineLoad url={'http://10.23.107.201:3030/real/load-data?table=tb_ksb61'}/>
                </div>
                <div class="col-sm" style={{margin: 2}}>
                    <KSB61EngineFuelRate url={'http://10.23.107.201:3030/real/fuel-data?table=tb_ksb61'}/>
                </div>
            </div>
        </div>
    );
