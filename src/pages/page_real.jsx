/**
 * PAGE FOR PROCESSING REAL TIME DATA
 */
        ...
        <div className="container-fluid" style={{backgroundColor: '86A7FC'}}>
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-5">
                    ...
                    {!UserSession.getIsAuthenticated()? <li className="nav-item"><a className="nav-link" href="/">Login</a></li> : UserSession.getLevel()===1? <li className="nav-item"><a className="nav-link" href="/admin">Admin</a>
            ...
            <div className="row g-0 mt-2">
                <div className="col-sm" style={{margin: 2}}>
                    <KSB61Flow url={'http://ksb-iot.intranet:3030/real/flow-data?table=' + tableName}/>
                </div>
                <div className="col-sm" style={{margin: 2}}>
                    <KSB61Pressure url={'http://ksb-iot.intranet:3030/real/press-data?table=' + tableName}/>
                </div>
                <div className="col-sm" style={{margin: 2}}>
                    <KSB61Temp url={'http://ksb-iot.intranet:3030/real/temp-data?table=' + tableName}/>
                </div>
            </div>
            <div className="row g-0 mt-2">
                <div className="col-sm" style={{margin: 2}}>
                    <KSB61EngineSpeed url={'http://ksb-iot.intranet:3030/real/speed-data?table=' + tableName}/>
                </div>
                <div className="col-sm" style={{margin: 2}}>
                    <KSB61EngineLoad url={'http://ksb-iot.intranet:3030/real/load-data?table=' + tableName}/>
                </div>
                <div className="col-sm" style={{margin: 2}}>
                    <KSB61EngineFuelRate url={'http://ksb-iot.intranet:3030/real/fuel-data?table=' + tableName}/>
                </div>
            </div>
        </div>
    );
